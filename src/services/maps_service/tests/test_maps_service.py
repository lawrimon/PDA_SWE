...
@pytest.mark.parametrize('origin,destination,mode,expected_status_code,expected_error', [
    ('52.370216,4.895168', '53.23445344722573,5.622244185533128', 'driving', 200, None),
    (None, None, None, 400, 'Missing parameters'),
    ('52.370216,4.895168', '53.23445344722573,5.622244185533128', 'invalid', 400, 'Invalid parameters'),
])
def test_get_route(client, origin, destination, mode, expected_status_code, expected_error):
    ...
    response = client.get('/route', query_string={'origin': origin, 'destination': destination, 'mode': mode})
