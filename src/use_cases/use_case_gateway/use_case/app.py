...
def check_appointment_interference(appointments, event):
    ...
    for appointment in appointments:
        ...
        if (appointment_time <= event_time <= appointment_time + appointment_duration) or \
           (appointment_time <= event_time + appointment_duration <= appointment_time + appointment_duration):
            return True
