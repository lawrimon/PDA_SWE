...
def get_events(location, keyword_list, enddate):
    ...
    try:
        ...
        data = response.json()
        for i in data:
            event_list += ("On the " + i["date"] + " in " + i["location"] + " you can see " + i["name"] + ". " + " The price is: " + i["price"] + " and the topic of the event is: " + i["topic"] + " .")
        return event_list
...
def get_sports(team_shortcuts, team_names):
    ...
    for i in team_shortcuts:
        ...
        game = "Your favorite team: " + team_names[count] + " is playing against: " + other_team +  " on the: " + date_str + " at: " + time_str + " ."
...
def get_scuttlebutt():
    ...
    lookout_string = "We have following events based on your favorite artists: " + events + " and following soccer games based on your preferences " + sports + "Thank you for listening. Do you want any additional information? "
